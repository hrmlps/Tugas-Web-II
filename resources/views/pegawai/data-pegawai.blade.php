            ...
            <div class="card card-primary card-outline">
                <div class="card-header">
                    <div class="card-tools">
                        <a href="/pegawai/create" class="btn btn-success">Tambah data  <i class="fas fa-plus-square"></i></a>
                    </div>
                </div>
                <div class="card-body">
                <table class="table table-bordered text-center">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$pgw->umur}}</td>
                            <td>{{$pgw->alamat}}</td>
                            <td>{{$pgw->jabatan->nmjabatan}}</td>
                            <td>
                                <a href="{{ route('get.ubah', $pgw->id) }}" class="btn btn-primary mb-2 bg-info text-white" > Ubah</a>
                                    
                                <form action="{{ route('delete.hapus', $pgw->id) }}" method="post">
                                    @csrf
                                    @method('DELETE')
